...
public class TopPageViewModel : ReactiveObject
{
    ...
    [Reactive]
    public IEnumerable<CurrencyViewModel> TopCurrencies { get; private set; }

    public ReactiveCommand<Unit, IEnumerable<CurrencyViewModel>> LoadTopCurrencies { get; private set; }
